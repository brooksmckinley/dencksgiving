...
fn refresh_main(siv: &mut Cursive) {
    ...
    let dialog = Dialog::around(
        LinearLayout::vertical()
            ...
            .child(Button::new("Feed Mashed Potatos", |s| {
                button_clicked(s, Food::MashedPotatos)
            }))
            .child(Button::new(
                "Feed Green Beans (with that nasty stuff on top)",
                |s| button_clicked(s, Food::GreenBeans),
            ))
            .child(Button::new("Feed Casserole", |s| {
                button_clicked(s, Food::Casserole)
            }))
            .child(Button::new("MIX HIS FOODS", |s| {
                button_clicked(s, Food::Mix)
            }))
            .child(DummyView)
